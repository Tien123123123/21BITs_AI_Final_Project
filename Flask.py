...
def pretrain_contentbase_api():
    try:
        ...
        pretrain = pretrain_contentbase(arg_parse_contentbase(), q_drant_end_point, q_drant_collection_name, minio_bucket_name = "models", k=k)
        return jsonify({
            "result": pretrain
        })
    except Exception as e:
...
def pretrain_collaborative_api():
    try:
        ...
        pretrain = pretrain_collaborative(arg_parse_collaborative(), q_drant_end_point, q_drant_collection_name, minio_bucket_name = "models")
        return jsonify({
            "result": pretrain
        })
    except Exception as e:
